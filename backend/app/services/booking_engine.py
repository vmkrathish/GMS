...
from app.models.models import Booking, BookingEvent
    ...
    if action == "accept":
        ...
        if amt > 0:
            ...
            notif = dict(to=booking.customer_id, type="payment",
                         ...
                         body=f"{me} accepted! Pay ₹{amt:g} advance to confirm your booking.")
        else:
            ...
            notif = dict(to=booking.customer_id, type="booking_status",
                         ...
                         body=f"{me} confirmed your booking — no advance required.")
        ...
        notif = dict(to=booking.provider_id, type="booking_status",
                     ...
                     body=f"{me} suggested another time for the booking.")
